...
res_dir = os.path.join(user_home, 'simulations', 'results', 'cl_2samples_1kHz')
...
for atm_name, draws in atm_cases.items():
    ...
    test_logger.logger.info(f"=== [{current_case_idx}/{total_cases}] Starting CL 2samples Validation for {atm_name} {draw_name} ===")
    ...
    res_file_name = f"res_2samples_1kHz_{vibr_label}_{atm_name}_{draw_name}.h5"
