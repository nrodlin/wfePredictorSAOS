...
res_dir = os.path.join(user_home, 'simulations', 'results', 'cl_2samplesPrediction_1kHz')
...
for atm_name, draws in atm_cases.items():
    ...
    res_file_name = f"res_2samplesPredictor_1kHz_{vibr_label}_{atm_name}_{draw_name}.h5"
